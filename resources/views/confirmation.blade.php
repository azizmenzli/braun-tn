...
<body class="bg-gray-50 font-sans">
    ...
    <main class="container mx-auto px-4 py-40 max-w-4xl">
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            <a href="{{ url('/') }}" class="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg text-center transition duration-200">
                Retour à l'accueil
            </a>
            <a href="#" class="flex-1 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-3 px-6 rounded-lg text-center transition duration-200">
                Voir mes commandes
            </a>
        </div>
    </main>
