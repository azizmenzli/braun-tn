        ...
        <div class="relative" x-data="{ notificationTable: false }">
            ...
            <div class="flex items-center justify-between last:border-0 border-b border-gray pb-4 mb-4 last:pb-0 last:mb-0">
                <div class="flex items-center space-x-3">
                    ...
                    <a href="contact">
                        <div class="">
                        <h5 class="text-base mb-0 leading-none">{{ $messagesCount }} messages reçus en 24h</h5>
                ...
                <div class="">
                    ...
                    <span class="header-item">
                        <span class="text-tiny bg-red">{{ $ordersGroupedByRedOrder->sum('count') }}</span>  
                        <i class="icon-mail"></i>
                    </span>
...
<!--Message -->
    ...
    <a href="commandes">  <div class="">
                        <h5 class="text-base mb-0 leading-none">Commande en attente : {{ $orderGroup->red_order }}</h5>
                        <span class="text-tiny leading-none">  {{ $orderGroup->products_count }} Produits dans commande reçues en 24h</span>
                    </div></a>
                    @endforeach
                </div>
                <div class="">
        ...
        <div class="relative w-[70%] flex justify-end items-center" x-data="{ userOption: false }">
            ...
            <div 
                ...
                <div class="flex items-center space-x-3 border-b border-gray pb-3 mb-2">
                    ...
                    <div class="">
                        <h5 class="text-base mb-1 leading-none">  {{ Auth::user()->name ?? 'Utilisateur' }}
          
</h5>
                        <p class="mb-0 text-tiny leading-none">{{ Auth::user()->email ?? 'email' }}</p>
                    </div>
                </div>
                <ul>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('logout') }}" class="px-5 py-2 w-full block hover:bg-gray rounded-md hover:text-theme text-base">
                            Se déconnecter
                        </a>
                    </li>
                </ul>
