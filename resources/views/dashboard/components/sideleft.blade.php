            ...
            <ul>
                ...
                <li>
                    ...
                    <ul x-show="nav == 4" class="pl-[42px] pr-[20px] pb-3">
                        <li>
                            <a href="commandes" class="block font-normal w-full text-[#6D6F71] hover:text-theme nav-dot">Listes</a>
                        </li>
                        <li>
